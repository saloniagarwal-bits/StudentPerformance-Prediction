...
from src.performanceprediction.utils import save_object
import os

@dataclass
class DataTransformationConfig:
    #after feature engineering, the pickle file will be saved at this path
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            #divide train dataset to independent and dependent features
            input_train_df=train_df.drop([target_column], axis=1)
            target_train_df=train_df[target_column]

            #divide test dataset to independent and dependent features
            ...
            #these all fields are required for next cycle i.e. model trainer
